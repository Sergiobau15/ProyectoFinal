...
const ClienteConsulta = () => {
  ...
  // Función para manejar la selección de categoría y hacer scroll hacia la sección de productos
          ...
          <ul className="flex justify-center flex-wrap space-x-2">
            {categories.map((category) => (
              <li key={category} className="mb-2">
                <button
                  onClick={() => handleCategoryClick(category)} // Llamamos a la función de manejo de clic
